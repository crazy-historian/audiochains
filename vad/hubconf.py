...
def silero_vad_micro(**kwargs):
    ...
    """
    hub_dir = os.path.dirname(__file__)
    model = init_jit_model(model_path=f'{hub_dir}/files/model_micro.jit')
    utils = (get_speech_ts,
             get_speech_ts_adaptive,
             save_audio,
             read_audio,
...
def silero_vad_micro_8k(**kwargs):
    ...
    """
    hub_dir = os.path.dirname(__file__)
    model = init_jit_model(model_path=f'{hub_dir}/files/model_micro_8k.jit')
    utils = (get_speech_ts,
             get_speech_ts_adaptive,
             save_audio,
             read_audio,
...
def silero_vad_mini(**kwargs):
    ...
    """
    hub_dir = os.path.dirname(__file__)
    model = init_jit_model(model_path=f'{hub_dir}files/model_mini.jit')
    utils = (get_speech_ts,
             get_speech_ts_adaptive,
             save_audio,
             read_audio,
...
def silero_vad_mini_8k(**kwargs):
    ...
    """
    hub_dir = os.path.dirname(__file__)
    model = init_jit_model(model_path=f'{hub_dir}/files/model_mini_8k.jit')
    utils = (get_speech_ts,
             get_speech_ts_adaptive,
             save_audio,
             read_audio,
...
def silero_lang_detector(**kwargs):
    ...
    """
    hub_dir = os.path.dirname(__file__)
    model = init_jit_model(model_path=f'{hub_dir}/files/number_detector.jit')
    utils = (get_language,
             read_audio)
...
def silero_lang_detector_95(**kwargs):
    ...
    hub_dir = os.path.dirname(__file__)
    model = init_jit_model(model_path=f'{hub_dir}/files/lang_classifier_95.jit')

    with open(f'{hub_dir}/files/lang_dict_95.json', 'r') as f:
        lang_dict = json.load(f)

    with open(f'{hub_dir}/files/lang_group_dict_95.json', 'r') as f:
